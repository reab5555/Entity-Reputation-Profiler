...
* We tested correlations between the feelings or sentiments and dimensions such as the amount of views, the amount of likes, the amount of followers, the amount of shares, etc., but we received correlations that are not strong at all. For example, negative sentiment has a significant correlation of ***0.100 to the amount of reactions for tweets.
