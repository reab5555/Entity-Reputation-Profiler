...
### Advantages
It is worth to notice that if one directly ask ChatGPT or search the web about major problems about a newley released product for example the results cannot be validated, nor we know its output sources.
