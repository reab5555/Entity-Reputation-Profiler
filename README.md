...
The purpose of this project is to extract from the social network X a large number of tweets that contain some keyword, and to create a profile of the criticsms and praisings, as well as emotions and sentiments toward that keyword for a predefined time period. The results can be loaded into a visual graphical representation to gain important insights. this may be used for analyzing newley products, public figures, and names of organizations for product improvments, marketing, forensic, intelligence, or research purposes.
