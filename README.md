...
twitter_x_ext.py for extracting the tweets by keyword within a date range, as well as utilizing GPT for finding criticisms and praisings from the tweets, and twitter_x_cluster.py for reducing the criticisms and praisings into a meaningful list of insights by clustering and profiling major problems, criticisms, praisings, and other insights for further improvements.
