...
### Advantages
It is worth to notice that if one directly ask ChatGPT about major problems about a newley released product for example, however, the results or not validated, nor we know its output sources.   
