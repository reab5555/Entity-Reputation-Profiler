...
One can directly ask ChatGPT for example about major problems about a newley released product, however, the results or not validated, nor we know its output sources.   
